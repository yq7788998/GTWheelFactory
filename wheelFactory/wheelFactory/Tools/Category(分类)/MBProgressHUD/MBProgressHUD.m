...
- (void)layoutSubviews {
	...
	CGRect labelF;
	labelF.origin.y = yPos+self.labelYOffset;
...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat width = self.labelYOffset > 0 ? 80 : size.width;
    CGFloat height = self.labelYOffset > 0 ? 80 : size.height;
	CGRect boxRect = CGRectMake(round((allRect.size.width - width) / 2) + self.xOffset,
								round((allRect.size.height - height) / 2) + self.yOffset, width, height);
